/* Class            :Computer Operating Systems   */
/* Homework         :Homework 3                   */
/* Name & Surname   :Melik Mehmet Bıyık           */
/* ID               :150160534                    */ 
    ...
    *(priority_flag+2) = 0;     /* assign intruder counter initially 0 */
    ...
    /******************************************************/
        ...
        while (1)                                   /* run until all child process leaves critical section */
        {
            ...
            /* *(priority_flag+2) is a counter which counts the processes in the critical section, we can accept that this variable is secondary priority.It means it provide synchronization among the same color boxes. */
